...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="./resources/test-automation-pyramid-dark.png">
  <img alt="test-automation-pyramid image" src="./resources/test-automation-pyramid.png">
</picture>
